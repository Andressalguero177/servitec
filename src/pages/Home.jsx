      ...
      <div className='container-hero'>
        <div id="hero">
          ...
          <p>Comprometidos con el correcto funcionamiento de tus equipos, somo una emporesa especializada en
            ...
            <div className="btn">
              <button><NavLink to="/contact" onClick={() => setMenuAbierto(false)}>Contactanos ya!!</NavLink></button>
            </div>
        </div>
        <div id="somos-proya">
          <div class="container">
          ...
          <div className="btn">
            <button><NavLink to="/about" onClick={() => setMenuAbierto(false)}>About</NavLink></button>
          </div>
        </div>
